...
from interfaces.vive import triad_openvr, triad_openvr_tracker
...
class ViveHandler:
    ...
    def get_vive_pose(self):
        ...
        pos = np.multiply(1000, [vive_pose.m[0][3], vive_pose.m[1][3], vive_pose.m[2][3]])
        ...
        return pos.tolist() + rot
    
class ViveTrackerHandler:
    def __init__(self, device_name="tracker_1", trigger_name="power_button"):
        self.device_name = device_name
        self.trigger_name = trigger_name
        self.v = None

    def init_vive(self):
        self.v = triad_openvr_tracker.triad_openvr()
        self.v.print_discovered_objects()

    def get_vive_input(self):
        return self.v.enable
